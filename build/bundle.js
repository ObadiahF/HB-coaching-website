...
var app = (function () {
    ...
    const file$7 = "src/components/nav-bar.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			attr_dev(i, "class", "fa-solid fa-bars svelte-1b5sg4w");
    			set_style(i, "color", "#ffffff");
    			add_location(i, file$7, 26, 16, 772);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			attr_dev(i, "class", "fa-solid fa-x svelte-1b5sg4w");
    			set_style(i, "color", "#ffffff");
    			add_location(i, file$7, 24, 16, 682);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(script, "class", "svelte-1b5sg4w");
    			add_location(script, file$7, 1, 4, 18);
    			attr_dev(h1, "class", "svelte-1b5sg4w");
    			add_location(h1, file$7, 13, 8, 262);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-1b5sg4w");
    			add_location(a0, file$7, 15, 16, 364);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-1b5sg4w");
    			add_location(a1, file$7, 16, 16, 401);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-1b5sg4w");
    			add_location(a2, file$7, 17, 16, 441);
    			attr_dev(a3, "href", "/");
    			attr_dev(a3, "class", "svelte-1b5sg4w");
    			add_location(a3, file$7, 18, 16, 483);
    			attr_dev(button0, "id", "signIn");
    			attr_dev(button0, "class", "svelte-1b5sg4w");
    			add_location(button0, file$7, 19, 16, 523);
    			attr_dev(ul, "class", ul_class_value = "" + (null_to_empty(/*open*/ ctx[0] === false ? 'nav-items' : 'mobile') + " svelte-1b5sg4w"));
    			add_location(ul, file$7, 14, 12, 295);
    			attr_dev(button1, "id", "mobile");
    			attr_dev(button1, "class", "svelte-1b5sg4w");
    			add_location(button1, file$7, 22, 8, 594);
    			attr_dev(div, "class", "nav-bar svelte-1b5sg4w");
    			add_location(div, file$7, 12, 0, 232);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button1, "click", /*toggleMobileMenu*/ ctx[1], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*open*/ 1 && ul_class_value !== (ul_class_value = "" + (null_to_empty(/*open*/ ctx[0] === false ? 'nav-items' : 'mobile') + " svelte-1b5sg4w"))) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ open, toggleMobileMenu });
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 22, 8, 893);
    			attr_dev(div6, "class", "picture-container svelte-17sdxeu");
    			add_location(div6, file$6, 21, 4, 853);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe1, file$4, 10, 8, 427);
    			...
    			add_location(iframe2, file$4, 11, 8, 708);
