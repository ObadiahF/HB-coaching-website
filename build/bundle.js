    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$7, 49, 16, 1435);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(i, "color", "#ffffff");
    			add_location(i, file$7, 47, 16, 1345);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 26, 8, 1055);
    			attr_dev(div6, "class", "picture-container svelte-17sdxeu");
    			add_location(div6, file$6, 25, 4, 1015);
    			attr_dev(div7, "class", "container svelte-17sdxeu");
    			add_location(div7, file$6, 8, 0, 156);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
